    ...
    methods: {
      ...
      getList() {
        ...
        fetchList(this.listQuery).then(response => {
          ...
          this.list[0].reason="拍错/多拍/不想要";
          this.list[1].reason="材质、面料与商品描述不符";
          this.list[2].reason="等待时间太长了";
          this.list[3].reason="缺货";
          this.list[4].reason="尺寸拍错不喜欢、效果不好";
          this.list[5].reason="卖家发错货";
          this.list[6].reason="卖家虚假发货";
          this.list[7].reason="做工瑕疵";
          this.list[8].reason="颜色、款式、图案描述不符合";
          this.list[9].reason="大小尺寸与描述不符";
